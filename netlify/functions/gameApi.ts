...
const apiRequest = {
  getAllGames: async () => {
    const fields =
      'fields name, rating, id, genres, screenshots.image_id, videos.video_id, created_at, first_release_date, involved_companies.*, platforms.*, similar_games, summary, cover.image_id;';
